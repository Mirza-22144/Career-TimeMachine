...
//Adding alias function to search UX UI role which is stored in database as Web and Digital Interface Designer
// YourStory.jsx find a role by its common name too, without changing the
// stored label itself.
export const roleSearchAliases = {
...
export const stepTwoData = {
  ...
  subheading:
    "You do not need to remember everything. Start with what feels familiar.",
  ...
  translateNote:
    "We will translate this into the language employers use today.",
  ctaLabel: "Continue",
};
...
export const stepFourData = {
  ...
  noRoleDataMessage:
    "Current skill demand information is unavailable for this role.",
  allAlignedMessage:
    "You're already aligned with the current skill demand for your selected role.",
...
export const stepFiveData = {
  ...
  subheading:
    "Here is the journey you have mapped. Now choose where you are and what you want to explore next.",
