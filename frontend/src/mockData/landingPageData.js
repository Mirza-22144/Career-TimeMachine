...
export const experienceSkills = [
  ...
  { id: 'java', name: 'Java', left: 800, top: 158, contextLabel: 'Experience you can carry forward' },
...
export const pastSkills = [
  ...
  { id: 'rest-apis', name: 'REST APIs', leadsTo: ['cloud-devops', 'data-engineering'] },
  { id: 'problem-solving', name: 'Problem Solving', leadsTo: ['ai-ml', 'cyber-security'] },
]

export const newHorizons = [
  { id: 'cloud-devops', name: 'Cloud & DevOps', description: 'Where your systems thinking fits' },
  { id: 'data-engineering', name: 'Data Engineering', description: 'Where your systems thinking fits' },
  { id: 'ai-ml', name: 'AI & ML', description: 'Where your systems thinking fits' },
  { id: 'cyber-security', name: 'Cyber Security', description: 'Where your systems thinking fits' },
]
...
export const eportfolioSection = {
  ...
  preview: {
    ...
    badge: 'Yours to keep',
    sections: [
      { id: 'professional-background', title: 'Professional Background', description: 'Role, years and the ground you covered', active: true },
      { id: 'skills-technologies', title: 'Skills & Technologies', description: 'What you kept and what you added', active: false },
      { id: 'practice-journey', title: 'Practice Journey', description: 'Scenarios you worked through', active: false },
      { id: 'reflections-growth', title: 'Reflections & Growth', description: 'What you noticed about yourself', active: false },
    ],
  },
...
export const footerSection = {
  ...
  columns: [
    { heading: 'PRODUCT', links: ['How it works', 'Practise scenarios', 'Your ePortfolio', 'Start your journey'] },
    { heading: 'SUPPORT', links: ['Contact us'] },
    { heading: 'LEGAL', links: ['Privacy policy', 'Terms of use', 'Data and consent'] },
  ],
...
export const practiceScenario = {
  url: 'careertimemachine.app / practice',
  scenarioLabel: 'SCENARIO 01 · INCIDENT RESPONSE',
  question: 'A service is down in production. Users are affected. What would you do first?',
...
export const journeyMilestones = [
  { id: 'remember', step: '01', title: 'REMEMBER', caption: 'My experience', top: -16, sectionId: 'remember', pending: false },
  { id: 'discover', step: '02', title: 'DISCOVER', caption: 'What is relevant today', top: 910, sectionId: 'discover', pending: false },
  { id: 'practise', step: '03', title: 'PRACTISE', caption: 'Try it before you return', top: 1743, sectionId: 'practise', pending: false },
  { id: 'adapt', step: '04', title: 'GROW', caption: 'Feedback and reflection', top: 2641, sectionId: 'adapt', pending: false },
  { id: 'move-forward', step: '05', title: 'MOVE FORWARD', caption: 'Confidence to return', top: 4421, sectionId: 'eportfolio', pending: false },
]
